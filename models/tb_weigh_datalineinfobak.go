...
type Tb_weigh_datalineinfobak struct {
	Id                       int64
	RecordId                 int64
	...
	Attribute15              string
	Attribute16              string
	CreateRecordUserCode     string `xorm:"varchar(64)"`
	CreateRecordUserName     string `xorm:"varchar(64)"`
	CreateRecordTime         time.Time
	OperationType            string `xorm:"varchar(64)"`
	Description              string
}
